...
$f\in L^2([0,2\pi])$
	...
	\begin{definition}[Halbordnung, Totalordnung]
		Sei $M$ eine Menge. Eine Relation $\leq \subset M\times M$, heißt \textit{Halbordnung}, wenn 
			\begin{enumerate}
				\item TODO 
			\end{enumerate}
		\begin{enumerate}
	...
	\begin{lemma}[Lemma von Zorn]
		$M$ halbgeordnete Menge. Besitzt jede totalgeordnete Teilmenge $Z \subset M$ eine obere Schranke in $M$, dann besitzt $M$ eine obere Schranke.	
	\end{lemma}
	...
	\begin{proof}
		...
		Definiere Halbordnung $\ff{u}{i}{I} \subset \ff{y}{i}{J} :\aq I \subset J$ und $x_i = y_i \forall i \in I$.
		Sei $Z \subset M$ totalgeordnete Teilmenge, $Z = \{(x)_{i\in I_j} : j\in J \}$
 ...
 TODO ÜA \par 
	...
	\begin{proof}
		...
		Also $|I| = |\bigcup{j\in J} S_{x_j}| \subset |J| \cdot |\N| = |J|$. \par
		Analog $|J| \subseteq |I|$
	\end{proof}
...
\chapter{Einige Hauptsätze aus der Funktionalanalysis}			
	...
	\begin{definition}
					$X,Y$ topologischer Räume $f: X\to Y$ heißt \textit{offen}, falls $f(U) \subset Y$ offen in $Y \forall$ offenen $U\subset X$
	\end{definition}
	...
	\begin{proof}
		\begin{itemize}
			\item \qmarks{$i \to ii$} Sei $U \subset X$ offen  $\df \inv{(\inv{f})}(U) = f(U)$ offen, also $\inf{f}$ stetig.
		\item \qmarks{$ii \to i$} Sei $U \subset X$ offen, $\inv{f}$ stetig 
	...
	\begin{proof}
		...
		\begin{enumerate}[1. {Schritt}]
			...
			$\U{\varepsilon}{0} \subset \overline{T(U_N(0))}$.
			Aus $\U{\varepsilon}{0} \subset \frac{1}{2} \U{\varepsilon}{y_0} + \frac{1}{2} \U{\varepsilon}{-y_0}$ und 
			$\overline{T(U_N(0))} = \frac{1}{2} \overline{T(U_N(0))} + \frac{1}{2} \overline{T(U_N(0))} $		
			folgt $ \U{\varepsilon}{0} \subset \overline{T(U_N(0))}$
			$\df \U{\frac{\varepsilon}{N}}{0} \subset \overline{T(U_1(0))}$.
			$\varepsilon_0 := \frac{\varepsilon}{N}$.
			\item Wir zeigen $\U{\varepsilon_0}{0} \subset {T(U_1(0))}$
	...
	\begin{definition}[Graphenabgeschlossenheit]
		$X,Y$ metrische Räume, $f: X\to Y$ heißt \textit{graphenabgeschlossen}, wenn $G(f) \subset X\times Y$ abgeschlossen ist.	
	\end{definition}
