...
%TODO: Über das Beweiskästchen streiten wir nochmal ;) DS (<- Mein Namenskürzel)
	...
	\end{thm}
		\begin{proof}
			...
			Daraus folgt mit der Vollständigkeit von Y, dass $(Tx)$ in $Y$ für alle $x\in X$ konvergiert.
			Wir setzen nun $\disp T: X\to Y,\; Tx := \limes T_nx$. Dann folgt der Satz durch folgendes  (Warum genau? Wieso kann es nicht noch andere Operatoren geben?):
				\begin{enumerate}[a)]
